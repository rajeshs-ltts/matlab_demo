function cs = old_config_settings()
% MATLAB function for configuration set generated on 03-Jun-2020 12:33:07
...
cs.set_param('FixedStep', '0.5');   % Fixed-step size (fundamental sample time)
...
cs.set_param('ProdHWDeviceType', 'Atmel->AVR (8-bit)');   % Production device vendor and type
