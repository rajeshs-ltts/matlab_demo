...
% MATLAB function for configuration set generated on 03-Jun-2020 11:51:19
...
cs.set_param('StopTime', '1000');   % Stop time
...
cs.set_param('FixedStep', '0.25');   % Fixed-step size (fundamental sample time)
...
cs.set_param('ProdHWDeviceType', 'Infineon->C16x, XC16x');   % Production device vendor and type
...
cs.set_param('CovMetricRelationalBoundary', 'on');   % Enable relational boundary metric
cs.set_param('CovMetricSaturateOnIntegerOverflow', 'on');   % Enable saturation on integer overflow metric
cs.set_param('CovMetricObjectiveConstraint', 'on');   % Enable objectives and constraints metric
cs.set_param('CovMetricSignalSize', 'on');   % Enable signal size metric
cs.set_param('CovMetricSignalRange', 'on');   % Enable signal range metric
cs.set_param('CovMetricLookupTable', 'on');   % Enable lookup table metric
cs.set_param('CovMetricStructuralLevel', 'Decision');   % Structural coverage level
cs.set_param('CovMetricSettings', 'dtrzoibw');   % Coverage metric settings
